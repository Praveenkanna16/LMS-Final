...
const Analytics: React.FC = () => {
  ...
  // Mock data for charts (you'll replace this with real data from backend)
  const userGrowthData = [
    { month: 'Jan', users: 120, active: 85 },
    { month: 'Feb', users: 180, active: 130 },
    { month: 'Mar', users: 250, active: 190 },
    { month: 'Apr', users: 320, active: 240 },
    { month: 'May', users: 410, active: 310 },
    { month: 'Jun', users: 520, active: 390 },
  ];

  const activeHoursData = [
    { hour: '6 AM', students: 20 },
    { hour: '9 AM', students: 85 },
    { hour: '12 PM', students: 120 },
    { hour: '3 PM', students: 150 },
    { hour: '6 PM', students: 180 },
    { hour: '9 PM', students: 95 },
  ];
  ...
  const batchPerformanceData = [
    { batch: 'Batch A', performance: 85, students: 30 },
    { batch: 'Batch B', performance: 92, students: 28 },
    { batch: 'Batch C', performance: 78, students: 32 },
    { batch: 'Batch D', performance: 88, students: 25 },
  ];

  const teacherPerformanceData = [
    { name: 'Dr. Smith', rating: 4.8, classes: 45 },
    { name: 'Prof. Johnson', rating: 4.6, classes: 38 },
    { name: 'Mr. Williams', rating: 4.9, classes: 52 },
    { name: 'Ms. Brown', rating: 4.5, classes: 41 },
  ];
