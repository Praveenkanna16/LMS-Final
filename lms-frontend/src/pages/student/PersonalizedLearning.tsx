                  ...
                  <CardContent className='p-6 space-y-6'>
                    ...
                    <div className='space-y-4'>
                      ...
                      {path.courses.map((course, index) => (
                        <div
                          key={course.id}
                          className={`flex items-center justify-between p-4 rounded-xl border-2 transition-all duration-200 ${course.completed
                        ...
                        >
                          <div className='flex items-center space-x-4'>
                            <div
                              className={`w-10 h-10 rounded-xl flex items-center justify-center ${course.completed
