...
export const Navbar = () => {
  ...
  const { cartCount, wishlistCount } = useCartWishlistCounts();
          ...
          <div className='flex justify-between items-center h-16'>
            ...
            <div className='hidden lg:flex items-center space-x-8'>
              ...
              <div className='relative group'>
                ...
                <div className='absolute top-full left-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2'>
                  <div className='p-4'>
              ...
              <div className='relative group'>
                ...
                <div className='absolute top-full left-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2'>
                  <div className='py-2'>
                    <Link
                      to='/courses'
              ...
              {isAuthenticated ? (
                <div className='flex items-center space-x-4'>
                  ...
                  <div className='relative group'>
                    ...
                    <div className='absolute top-full right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform group-hover:translate-y-0 translate-y-2'>
                      <div className='p-4'>
                          ...
                          <div className='mb-4 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg'>
                            <div className='flex items-center justify-between text-sm'>
                              ...
                              <span className='font-medium text-gray-900'>
                                {user.gamification.experience} /{' '}
                                {user.gamification.experienceToNext}
                              </span>
                            </div>
